...
export async function initDeviceAuth(input: { baseUrl: string; clientVersion: string }): Promise<{
  deviceCode: string;
  userCode: string;
  ...
  return apiPost(
    ...
    { clientName: "xpense", clientVersion: input.clientVersion },
    { baseUrl: input.baseUrl }
  );
}
